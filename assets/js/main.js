...
const LOGO_SVG = `<svg width="56" height="56" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(28,28)">
    ...
    <!-- YANTRA — 4 continuous crossing paths, N/S lasso rings, 4 scroll tip circles -->
    <!-- Path A: N-left → right-crossing → E-lower -->
    <path d="M -1.0,-5.5 C 0.5,-4.5 2.0,-2.0 3.5,0 C 4.5,0.8 5.5,2.0 6.0,3.2"
          fill="none" stroke="#d4a644" stroke-width="1.2" stroke-linecap="round"/>
    <!-- Path B: N-right → left-crossing → W-lower -->
    <path d="M 1.0,-5.5 C -0.5,-4.5 -2.0,-2.0 -3.5,0 C -4.5,0.8 -5.5,2.0 -6.0,3.2"
          fill="none" stroke="#d4a644" stroke-width="1.2" stroke-linecap="round"/>
    <!-- Path C: S-right → left-crossing → W-upper -->
    <path d="M 1.0,5.5 C -0.5,4.5 -2.0,2.0 -3.5,0 C -4.5,-0.8 -5.5,-2.0 -6.0,-3.2"
          fill="none" stroke="#d4a644" stroke-width="1.2" stroke-linecap="round"/>
    <!-- Path D: S-left → right-crossing → E-upper -->
    <path d="M -1.0,5.5 C 0.5,4.5 2.0,2.0 3.5,0 C 4.5,-0.8 5.5,-2.0 6.0,-3.2"
          fill="none" stroke="#d4a644" stroke-width="1.2" stroke-linecap="round"/>
    <!-- N lasso ring (drawn last — covers path start points) -->
    <circle cx="0" cy="-6.5" r="1.35" fill="#100d20" stroke="#d4a644" stroke-width="1.2"/>
    <!-- S lasso ring -->
    <circle cx="0" cy="6.5" r="1.35" fill="#100d20" stroke="#d4a644" stroke-width="1.2"/>
    <!-- Scroll tip circles -->
    <circle cx="6.0"  cy="3.2"  r="0.75" fill="#100d20" stroke="#d4a644" stroke-width="1.0"/>
    <circle cx="-6.0" cy="3.2"  r="0.75" fill="#100d20" stroke="#d4a644" stroke-width="1.0"/>
    <circle cx="-6.0" cy="-3.2" r="0.75" fill="#100d20" stroke="#d4a644" stroke-width="1.0"/>
    <circle cx="6.0"  cy="-3.2" r="0.75" fill="#100d20" stroke="#d4a644" stroke-width="1.0"/>
  </g>
